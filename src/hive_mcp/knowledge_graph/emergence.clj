(ns hive-mcp.knowledge-graph.emergence
  "GE module — cluster detection and synthetic node creation.
...
(defn scan-groups
  "Scan for entry groups via extension delegate.
...
(defn detect-and-create!
  "End-to-end cluster detection and synthetic node creation.
   Delegates to extension if available."
  [& [opts]]
...
(defn ge-report
  "Generate a human-readable cluster detection report.
   Delegates to extension if available."
  [& [opts]]
